...
public class register extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session != null && session.getAttribute("logged").toString().equals("true")){
            ...
            out.println("<h3 class=\"blue-text text-lighten-1 center\">Register Tukang</h3>");
            out.println("</div>");
            ...
            out.println("</div>");
            out.println("<div class=\"input-field col s6\">");
            out.println("<input type=\"password\" name=\"password\" class=\"validate\" required/><br>");
            out.println("<label for=\"password\">Password</label>");
            out.println("</div>");
            out.println("<div class=\"input-field col s12\">");
            out.println("<input type=\"text\" name=\"name\" class=\"validate\" required/><br>");
            out.println("<label for=\"name\">Name</label>");
            out.println("</div>");
            out.println("<div class=\"input-field col s12\">");
            out.println("<input type=\"text\" name=\"address\" class=\"validate\" required/><br>");
